...
class ZMybatisLearnApplicationTests {
    ...
    void test01() {
        ...
        int delete = teacherMapper.delete(lambdaQueryWrapper);
    }
    ...
    void test02() {
        ...
        teacher.setTname("ifjosufos");
        teacher.setTid("02");
        teacher.setBirthday(LocalDateTime.parse("1998-09-07 12:12:12", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
        LambdaQueryWrapper<Teacher> lambdaQueryWrapper = new LambdaQueryWrapper<>();
        lambdaQueryWrapper.eq(Teacher::getTid, "02");
        lambdaQueryWrapper.clear();
        lambdaQueryWrapper.notLike(Teacher::getTid, "02");
        int update = teacherMapper.update(teacher, lambdaQueryWrapper);
